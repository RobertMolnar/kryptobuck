...
uint256 hashGenesisBlock("0x5dc38dbb12fca0254b6fd98954bad68fb0c8646816cce5a4b231dca24d812c81");
...
const string strMessageMagic = "KryptoBuck Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // kryptobuck: 1 days
static const int64 nTargetSpacing = 60; // kryptobuck: 60 sec blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal kryptobuck miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "kryptobuck", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd89f45ff8714925972c0d928ebde9ddc13a19fba8450b21400d7c7408fcea760");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Good Luck, January 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1419661581; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 560814;

        if (fTestNet)
        {
            block.nTime    = 1419661581;
            block.nNonce   = 521924;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa2b943709390396c8e6e4c9fb5fece6baab6236eb7bc5bdd3d4a05c79dd71838"));
